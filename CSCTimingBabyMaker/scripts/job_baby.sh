...
then
	...
	#root -l 'dumpPlots.C("../test/output_'$RUNNUM'_timing.root","'$RUNNUM'","removeAnodeCorr")'
        ...
        root -l 'combineSegmentTimingDistributions.C("../test/output_'$RUNNUM'_timing.root","Diff")'
	root -l 'combineSegmentTimingDistributions.C("../test/output_'$RUNNUM'_timing.root","Combined")'
	root -l 'combineSegmentTimingDistributions.C("../test/output_'$RUNNUM'_timing.root","Anode")'
	root -l 'combineSegmentTimingDistributions.C("../test/output_'$RUNNUM'_timing.root","Cathode")'
	...
	root -l 'chamberTimePlot.C("../test/output_'$RUNNUM'_timing.root")'
        ...
        root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",true,"Diff")'
	root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",false,"Diff")'
	root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",true,"Combined")'
        root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",false,"Combined")'
	root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",true,"Anode")'
        root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",false,"Anode")'
	root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",true,"Cathode")'
        root -l 'makeSegmentMeanTimingPlot.C("../test/output_'$RUNNUM'_timing.root",false,"Cathode")'
